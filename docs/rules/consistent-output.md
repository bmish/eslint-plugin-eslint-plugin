# Enforce use of output assertions in rule tests (consistent-output)
...
This rule ensures all tests have output assertions.
...
* `"always"` - (default) always require invalid test cases to have output assertions
* `"consistent"` - if any invalid test cases have output assertions, then all invalid test cases must have output assertions
